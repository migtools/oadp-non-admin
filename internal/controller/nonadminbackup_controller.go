...
//+kubebuilder:rbac:groups=oadp.openshift.io.oadp.openshift.io,resources=nonadminbackups,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=oadp.openshift.io.oadp.openshift.io,resources=nonadminbackups/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=oadp.openshift.io.oadp.openshift.io,resources=nonadminbackups/finalizers,verbs=update
