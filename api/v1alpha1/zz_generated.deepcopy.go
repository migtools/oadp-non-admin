...
func (in *NonAdminBackupStorageLocationRequestStatus) DeepCopyInto(out *NonAdminBackupStorageLocationRequestStatus) {
	*out = *in
	if in.NonAdminBackupStorageLocationRequestStatusInfo != nil {
		in, out := &in.NonAdminBackupStorageLocationRequestStatusInfo, &out.NonAdminBackupStorageLocationRequestStatusInfo
		*out = new(NonAdminBackupStorageLocationRequestStatusInfo)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NonAdminBackupStorageLocationRequestStatusInfo) DeepCopyInto(out *NonAdminBackupStorageLocationRequestStatusInfo) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NonAdminBackupStorageLocationRequestStatusInfo.
func (in *NonAdminBackupStorageLocationRequestStatusInfo) DeepCopy() *NonAdminBackupStorageLocationRequestStatusInfo {
	if in == nil {
		return nil
	}
	out := new(NonAdminBackupStorageLocationRequestStatusInfo)
