...
func (in *NonAdminScheduleStatus) DeepCopyInto(out *NonAdminScheduleStatus) {
	*out = *in
	...
	if in.LastBackup != nil {
		...
		*out = new(NonAdminScheduledBackup)
		(*in).DeepCopyInto(*out)
	}
	if in.RecentBackups != nil {
		in, out := &in.RecentBackups, &out.RecentBackups
		*out = make([]NonAdminScheduledBackup, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NonAdminScheduleTemplate) DeepCopyInto(out *NonAdminScheduleTemplate) {
	*out = *in
	if in.BackupSpec != nil {
		in, out := &in.BackupSpec, &out.BackupSpec
		*out = new(v1.BackupSpec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NonAdminScheduleTemplate.
func (in *NonAdminScheduleTemplate) DeepCopy() *NonAdminScheduleTemplate {
	if in == nil {
		return nil
	}
	out := new(NonAdminScheduleTemplate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NonAdminScheduledBackup) DeepCopyInto(out *NonAdminScheduledBackup) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NonAdminScheduledBackup.
func (in *NonAdminScheduledBackup) DeepCopy() *NonAdminScheduledBackup {
	if in == nil {
		return nil
	}
	out := new(NonAdminScheduledBackup)
