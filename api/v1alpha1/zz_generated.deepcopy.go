...
func (in *NonAdminBackupStatus) DeepCopyInto(out *NonAdminBackupStatus) {
	*out = *in
	if in.VeleroBackupStatus != nil {
		in, out := &in.VeleroBackupStatus, &out.VeleroBackupStatus
		*out = new(v1.BackupStatus)
		(*in).DeepCopyInto(*out)
	}
	if in.VeleroObject != nil {
		in, out := &in.VeleroObject, &out.VeleroObject
		*out = new(VeleroObject)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VeleroNameNamespace) DeepCopyInto(out *VeleroNameNamespace) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VeleroNameNamespace.
func (in *VeleroNameNamespace) DeepCopy() *VeleroNameNamespace {
	if in == nil {
		return nil
	}
	out := new(VeleroNameNamespace)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VeleroObject) DeepCopyInto(out *VeleroObject) {
	*out = *in
	if in.Status != nil {
	...
	out.VeleroNameNamespace = in.VeleroNameNamespace
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VeleroObject.
func (in *VeleroObject) DeepCopy() *VeleroObject {
	if in == nil {
		return nil
	}
	out := new(VeleroObject)
