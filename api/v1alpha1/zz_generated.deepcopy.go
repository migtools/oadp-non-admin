...
func (in *NonAdminBackupStorageLocationRequestStatus) DeepCopyInto(out *NonAdminBackupStorageLocationRequestStatus) {
	*out = *in
	if in.VeleroBackupStorageLocationRequest != nil {
		in, out := &in.VeleroBackupStorageLocationRequest, &out.VeleroBackupStorageLocationRequest
		*out = new(VeleroBackupStorageLocationRequest)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VeleroBackupStorageLocationRequest) DeepCopyInto(out *VeleroBackupStorageLocationRequest) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VeleroBackupStorageLocationRequest.
func (in *VeleroBackupStorageLocationRequest) DeepCopy() *VeleroBackupStorageLocationRequest {
	if in == nil {
		return nil
	}
	out := new(VeleroBackupStorageLocationRequest)
