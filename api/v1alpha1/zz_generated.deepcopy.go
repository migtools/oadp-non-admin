...
func (in *NonAdminBackupStatus) DeepCopyInto(out *NonAdminBackupStatus) {
	*out = *in
	...
	if in.DataUploadStatus != nil {
		in, out := &in.DataUploadStatus, &out.DataUploadStatus
		*out = make([]v2alpha1.DataUploadStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PodVolumeBackupStatus != nil {
		in, out := &in.PodVolumeBackupStatus, &out.PodVolumeBackupStatus
		*out = make([]PodVolumeBackupStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PodVolumeBackupStatus) DeepCopyInto(out *PodVolumeBackupStatus) {
	*out = *in
	if in.Status != nil {
		...
		*out = new(v1.PodVolumeBackupStatus)
		(*in).DeepCopyInto(*out)
	}
}
